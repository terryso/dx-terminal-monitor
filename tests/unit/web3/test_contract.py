...
class TestABIFileLoading:
    ...
    def test_abi_contains_required_functions(self):
        ...
        function_names = [item.get("name") for item in abi_data if item.get("type") == "function"]
...
class TestSendTransactionMethod:
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_returns_transaction_hash(
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_handles_gas_estimation(
        self, web3_test_env, mock_web3_components
    ):
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_signs_with_private_key(
        self, web3_test_env, mock_web3_components
    ):
...
class TestSendTransactionErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_returns_error_on_gas_failure(
        self, web3_test_env, mock_web3_components
    ):
        """_send_transaction should return error dict on gas estimation failure."""
        mock_w3, mock_account, mock_contract = mock_web3_components

        mock_contract.functions.testMethod.return_value.estimate_gas.side_effect = Exception(
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_returns_error_on_tx_failure(
        self, web3_test_env, mock_web3_components
    ):
    ...
    @pytest.mark.asyncio
    async def test_send_transaction_returns_error_on_receipt_failure(
        self, web3_test_env, mock_web3_components
    ):
...
class TestAddStrategyMethod:
    ...
    async def test_contract_add_strategy_returns_error_on_failure(
        ...
        mock_contract.functions.addStrategy.return_value.estimate_gas.side_effect = Exception(
            "Max strategies limit reached"
        )
